        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Professor_DepartmentId = table.Column<int>(type: "int", nullable: true),
                    Specialization = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    DepartmentId = table.Column<int>(type: "int", nullable: true),
                    GPA = table.Column<decimal>(type: "decimal(4,2)", precision: 3, scale: 2, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Departments_Professor_DepartmentId",
                        column: x => x.Professor_DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    JoinCodeExpiry = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teams_Users_ProfessorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Feedbacks_Users_ProfessorId",
                        column: x => x.ProfessorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OriginalityReports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OriginalityReports_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectAttachments_Users_UploaderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VectorEmbeddings_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SimilarityPercentage = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    MatchReason = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OriginalityReportId = table.Column<int>(type: "int", nullable: false),
                    ReferencedProjectId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SimilarProjects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SimilarProjects_OriginalityReports_OriginalityReportId",
                        column: x => x.OriginalityReportId,
                        principalTable: "OriginalityReports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SimilarProjects_Projects_ReferencedProjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JoinRequests_StudentId_TeamId",
                table: "JoinRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JoinRequests_TeamId_Status",
                table: "JoinRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OriginalityReports_ProjectId_GeneratedAt",
                table: "OriginalityReports",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectAttachments_UploaderId",
                table: "ProjectAttachments",
                column: "UploaderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SimilarProjects_OriginalityReportId",
                table: "SimilarProjects",
                column: "OriginalityReportId");

            migrationBuilder.CreateIndex(
                name: "IX_SimilarProjects_ReferencedProjectId",
                table: "SimilarProjects",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teams_ProfessorId",
                table: "Teams",
                column: "ProfessorId");

            migrationBuilder.CreateIndex(
                name: "IX_Technologies_Category_Name",
                table: "Technologies",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_Professor_DepartmentId",
                table: "Users",
                column: "Professor_DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_VectorEmbeddings_ProjectId",

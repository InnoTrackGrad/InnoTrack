...
namespace InnoTrack.Application.Interfaces
{
    public interface IProfessorAdminService
    {
        ...
        Task<PagedResult<ProfessorAdminViewDto>> GetAllProfessorsAsync(string? search, int? departmentId, bool? isActive, bool? hasCapacity, int pageNumber, int pageSize);
